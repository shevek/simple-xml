...
public class Format {
   ...
   /**
    * Represents whether to use single quotes instead of double quotes for the generated XML.
    */
   ...
   public Format(int indent, String prolog, boolean singleQuote) {
      this(indent, prolog, new IdentityStyle(), singleQuote);
   }
   ...
   public Format(int indent, String prolog, Style style, boolean singleQuote) {
     this(indent, prolog, style, HIGH, singleQuote);
   }

   public Format(int indent, String prolog, Style style, Verbosity verbosity) {
       this(indent, prolog, style, verbosity, false);
   }
    ...
    * @param style this is the style to apply to the format object
    * @param verbosity this indicates the verbosity of the format
    * @param singleQuote this indicates the quote style of the format
    */
   public Format(int indent, String prolog, Style style, Verbosity verbosity, boolean singleQuote) {
